        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="d-inlinegrid w-100 bottom-card" style="margin-top:40px">
            <div class="row">
              ...
              <a href="" class="w-100 text-center link-text" style="margin:auto;"><img src="https://cinestar.com.vn/assets/images/icon-play-vid.svg" alt="">Xem trailer</a>
              </div>
              <div class="col-md-6">
...
<div class="container">
<div id="carouselPhimSapChieu" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
  ...
  <button class="carousel-control-prev" type="button" data-bs-target="#carouselPhimSapChieu" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class="carousel-control-next" type="button" data-bs-target="#carouselPhimSapChieu" data-bs-slide="next">
    <span class="carousel-control-next-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Next</span>
  </button>
</div>
