    ...
    <div class="container">
        <div class="seat-wr">
            <div class="seat-heading sec-heading">
                <h2 class="heading">CHỌN GHẾ - {{$ShowInfor->cinemahall->Name}}</h2>
            </div>
        </div>
                        ...
                        <div>
                            <div class="seat-table">
                                <table class="seat-table-inner">
                                    @foreach($RowPos as $rpKey=>$rpValue)
                                    @if(strcasecmp($rpValue->RowPosition,'A') == 0 || strcasecmp($rpValue->RowPosition,'B') == 0 || strcasecmp($rpValue->RowPosition,'C') == 0 || strcasecmp($rpValue->RowPosition,'D') == 0 || strcasecmp($rpValue->RowPosition,'E') == 0 || strcasecmp($rpValue->RowPosition,'F') == 0 || strcasecmp($rpValue->RowPosition,'G') == 0 || strcasecmp($rpValue->RowPosition,'H') == 0 || strcasecmp($rpValue->RowPosition,'J') == 0)
                                    <tr>
                                    ...
                                    @elseif(strcasecmp($rpValue->RowPosition,'K') == 0 || strcasecmp($rpValue->RowPosition,'L') == 0 || strcasecmp($rpValue->RowPosition,'M') == 0 || strcasecmp($rpValue->RowPosition,'N') == 0)
                                    <tr>
                                        <td class="seat-name-row">{{$rpValue->RowPosition}}</td>
                                        @foreach($Seat as $sKey => $sValue)
